...
search. Proof-based equivalence checks require a trusted reference formalization and may still depend on incomplete proof search~\citep{murphy2024autoformalizing,li2024symbolic,poiroux2024typecheck,liu2025beq}.\oren{please fix citations} As a result, existing evaluations often lack a scalable and deterministic way to determine whether the meaning of a source statement has been preserved.
